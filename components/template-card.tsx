...
export default function TemplateCard({ template }: TemplateCardProps) {
  return (
    <div className="group flex flex-col h-full bg-white rounded-xl shadow-luxury hover:shadow-luxury-lg transition-all duration-300 overflow-hidden border border-anthropic-200 hover:border-anthropic-300">
      ...
      <div className="flex-grow flex flex-col p-6 bg-anthropic-50/60 border-t border-anthropic-100">
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {template.features.slice(0, 2).map((feature, index) => (
              <span
                key={index}
                className="px-2 py-1 bg-white text-anthropic-700 text-xs rounded-full"
              >
                {feature}
              </span>
            ))}
        ...
        <div className="mt-auto flex items-center justify-between pt-4 border-t border-anthropic-100">
